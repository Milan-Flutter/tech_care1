...
import 'package:tech_care/Api/get_chat.dart';
import 'package:tech_care/Controller/profile_data.dart';
import 'package:tech_care/Model/getchat.dart';
import 'package:tech_care/View/chat/request_chat.dart';
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(
            ...
            add1()
              async {
                var response=await post(Uri.parse("https://mechodalgroup.xyz/tech_care/api/update_close_friend.php"),
                    body: {
