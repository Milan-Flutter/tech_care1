...
async {
  ...
  Response response =await post(Uri.parse("https://mechodalgroup.xyz/tech_care/api/update_f_id.php"),
  ...
  Future<void> Name()
  async {
    Response response =await post(Uri.parse("https://mechodalgroup.xyz/tech_care/api/update_name.php"),
